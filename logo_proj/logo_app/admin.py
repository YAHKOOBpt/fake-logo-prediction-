...
class CategoryAdmin(admin.ModelAdmin):
    list_display = ['name', 'display_image']  # Add any other fields you want to display

    def display_image(self, obj):
        if obj.imageURL:
            return format_html('<img src="{}" width="50px" height="50px" />'.format(obj.imageURL))
        else:
            return "No Image"
...
class ProductAdmin(admin.ModelAdmin):
    list_display = ['name', 'description', 'display_image', 'category']  # Add any other fields you want to display
